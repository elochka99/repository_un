...
print('Как Вы хотите вводить информацию в БД: вручную или рандомно? [1/2]\n'
      'если хотите посмотреть єффективность алкоритмов сортировки - нажмите [3]')
while True:
    try:
            ...
            while True:
                try:
                    ...
                    if ask == 1:
                        ...
                        order = input("1 - по возростанию \ 2 - в порядке убывания :")
                        if order == "1":
                            print("отсортированная последовательность selection_sort по возрастанию: ",
                                  selection_sort(A))
                        elif order == "2":
                            print("отсортированная последовательность selection_sort по убыванию: ",
                                  selection_sort(-A) * -1)
                        else:
                            print('Пожалуйста, введите корректные данные ☻\n')
                            continue
                        ...
                        order = input("1 - по возростанию \ 2 - в порядке убывания :")
                        if order == "1":
                            print("отсортированная последовательность insertion_sort по возрастанию: ",
                                  insertion_sort(A))
                        elif order == "2":
                            print("отсортированная последовательность insertion_sort по убыванию: ",
                                  insertion_sort(-A) * -1)
                        else:
                            print('Пожалуйста, введите корректные данные ☻\n')
                            continue
                        ...
                        if order == "1":
                            ...
                            print("отсортированная последовательность cocktail_sort по убыванию: ",
                                  cocktail_sort(-A) * -1)
                        else:
                            print('Пожалуйста, введите корректные данные ☻\n')
                            continue
