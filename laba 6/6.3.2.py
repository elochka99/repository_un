...
# Каждый из городов соединен с каждым городомю найти кратчайший маршрут,
# начинающийся в первом и проходящем через все остальные.
import numpy as np
def Dijkstra(N, S, matrix):
    ...
    :return: найименьшую длину каждого пути
    '''
    valid = [True]*N
    weight = [1000000]*N
    weight[S] = 0
