...
# программа создания на системном диске в каталоге NewFold  своего каталога, в нем текстового файла со своей анкетой и
# сформировать код программного вывода файла с анкетой на экран
import os
flag = True
while flag:
